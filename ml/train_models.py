...
model_configs = {
    ...
    "ARD": {
        "est":   ARDRegression(),
        "grid":  [{"max_iter": mi, "alpha_1": a1, "alpha_2": a2,
    ...
    "PLS": {
        "est":   PLSRegression(),
        "grid":  [{"n_components": n, "max_iter": mi}
                  for n  in range(1, 19)
                  for mi in [500, 1000]],
        "scale": True,
    },
    ...
    "Tweedie": {
        ...
        "grid":  [{"power": p, "alpha": a, "max_iter": mi}
    ...
    "KR": {
        "est":   KernelRidge(),
        "grid":  [{"alpha": a, "kernel": k, "gamma": g, "degree": d}
    ...
    "GPR": {
        "est":   GaussianProcessRegressor(random_state=RANDOM_SEED,
                                          n_restarts_optimizer=0),
        "grid":  [{"kernel": k, "alpha": a}
    ...
    "MLP": {
        ...
        "grid":  [{"hidden_layer_sizes": h, "activation": act,
                   "alpha": a, "learning_rate": lr,
    ...
    # ── Polynomial ───────────────────────────────────────────────────────────
    "PolyR": {
        "est":   Pipeline([("poly", PolynomialFeatures()),
                           ("ridge", Ridge(random_state=RANDOM_SEED))]),
        "grid":  [{"poly__degree": d, "poly__interaction_only": io,
                   "ridge__alpha": a}
                  for d  in [2, 3]
    ...
    "RF": {
        ...
        "grid":  [{"n_estimators": n, "max_depth": d,
                   ...
                   "max_features": mf, "max_samples": ms2}
    ...
    "GBDT": {
        ...
        "grid":  [{"n_estimators": n, "learning_rate": lr, "max_depth": d,
                   ...
                   "min_impurity_decrease": mid, "min_samples_leaf": ml}
    ...
    "HGB": {
        ...
        "grid":  [{"learning_rate": lr, "max_iter": it,
    ...
    "LightGBM": {
        ...
        "grid":  [{"n_estimators": n, "learning_rate": lr, "max_depth": d,
                   ...
                   "colsample_bytree": cbt, "reg_alpha": ra,
                   "reg_lambda": rl, "min_child_samples": mcs}
                  for n   in [100, 200, 300, 500]
                  for lr  in [0.005, 0.01, 0.05, 0.1, 0.2]
                  for d   in [-1, 5, 10, 15]
    ...
    "Voting": {
        "est":   VotingRegressor(
                     estimators=[
                         ...
                         ("lgb", lgb.LGBMRegressor(random_state=RANDOM_SEED,
                                                    verbosity=-1)),
                         ("cat", cb.CatBoostRegressor(random_state=RANDOM_SEED,
                                                      silent=True,
                                                      allow_writing_files=False)),
                         ("rf",  RandomForestRegressor(random_state=RANDOM_SEED)),
                     ],
        ...
        "grid":  [
            {"xgb__n_estimators": n, "xgb__learning_rate": lr,
             "lgb__n_estimators": n, "lgb__learning_rate": lr,
             "cat__iterations": n,   "cat__learning_rate": lr,
...
if HAS_NGBOOST:
    model_configs["NGBoost"] = {
        ...
        "grid":  [{"n_estimators": n, "learning_rate": lr,
                   "minibatch_frac": mf, "col_sample": cs}
...
for model_name, cfg in model_configs.items():
    ...
    print(f" ✔ Best CV MSE: {-search.best_score_:.4f}, k={best_k}, "
    ...
    final_pipe = Pipeline([
        ("select", FunctionTransformer(select_top_k_features,
                                       validate=False,
                                       kw_args={"k": best_k})),
